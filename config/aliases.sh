...
alias penv="source /home/vassilisp/.penv/bin/activate"
alias jsonview='jsonl-viewer'
# -------------------------------------------------------------------
# Slurm
# -------------------------------------------------------------------
...
alias newjupy='~/dotfiles/runpod/start_dev_jupyter.sh'
alias newdev='~/dotfiles/runpod/start_vscode_dev.sh'
