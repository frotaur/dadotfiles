...
/workspace-vast/vassilisp/envs/.penv. You can also double check its location by typing 'type penv'. This is the venv I use when I want to do
...
I'm often coding remotely on a runpod node, inside a cluster. I code through vscode, with ssh. Bear that in mind,
for instance if I ask to make a web-ui, it must not rely on asking the user to upload files from his computer,
since all the relevant files will be on the remote server.
